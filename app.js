async function init() {
  ...
  if (id) {
    ...
    gameMenu.innerHTML = `
    <button type="button" id="join-game" style="width:33%;margin-left:var(--board-margin);" onclick="joinGame();">uđi u partiju</button>
...
function shareQR() {
  ...
  qrDiv.setAttribute("id", "qr-code");
  document.querySelector("body").append(qrDiv);
